...
from setup import DUCKDB_PATH

parser = argparse.ArgumentParser()
parser.add_argument(
    "--random",
    action="store_true",
    help="Use random sampling for ratings",
)
parser.add_argument(
    "--nsamples",
    type=int,
    help="Number of ratings to sample",
)
...
sample_rating(duckdb_path=duckdb_path, nsamples=args.nsamples, random=args.random)
